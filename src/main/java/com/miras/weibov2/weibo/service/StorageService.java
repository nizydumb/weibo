...
////
    ...
    private final String postFolderPath = "C:/Users/nizzy/Documents/Posts/";
    private final String logoFolderPath = "C:/Users/nizzy/Documents/Logos/";



    public void save(MultipartFile file, long id, String folderPath) {
        try {
            Path path = Path.of(folderPath + id);
            try {
                Files.createDirectory(path);
            } catch (FileAlreadyExistsException e) {
...
//    public Resource load(String filename, long id, String folderPath) {
//        try {
//            Path root = Path.of(folderPath + id);
//            Path file = root.resolve(filename);
//            Resource resource = new UrlResource(file.toUri());
//
//            if (resource.exists() || resource.isReadable()) {
...
//        }
//    }
    public Resource load(long id, long imageId, String folderPath) {
        Resource resource = null;
        try {
            Path root = Path.of(folderPath + id);
            List<Path> pathList = loadAll(id, folderPath).collect(Collectors.toList());
...
//    public Resource load(long postId, long imageId, String folderPath) {
//        Resource resource = null;
//        try {
...
//    }
    ...
    public void deleteAll(long id, String folderPath) {
        Path root = Path.of(folderPath + id);
        FileSystemUtils.deleteRecursively(root.toFile());
    }


    public Stream<Path> loadAll(long id, String folderPath) {
        Path root = Path.of(folderPath + id);
        try {
